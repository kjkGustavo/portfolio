...
const Home: NextPage = () => {
  return (
    <main className="container items-center h-screen flex">
      <Head>
      ...
      <div className="px-4 md:mx-0 relative">
        <div className="bloom bloom-one"></div>
        <div className="bloom bloom-two"></div>
        <header className="mb-14">
          <div className="max-w-3xl">
            <h1
              className="text-4xl md:text-5xl lg:text-6xl font-bold flex items-center gap-5 fade-in-title"
